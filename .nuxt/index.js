...
import nuxt_plugin_plugin_5486fd46 from 'nuxt_plugin_plugin_5486fd46' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_plugin_69f8ffb7 from 'nuxt_plugin_plugin_69f8ffb7' // Source: .\\vuetify\\plugin.js (mode: 'all')
import nuxt_plugin_toast_2684b4a2 from 'nuxt_plugin_toast_2684b4a2' // Source: .\\toast.js (mode: 'client')
import nuxt_plugin_pluginutils_05cb9524 from 'nuxt_plugin_pluginutils_05cb9524' // Source: .\\nuxt-i18n\\plugin.utils.js (mode: 'all')
import nuxt_plugin_pluginrouting_5539c18e from 'nuxt_plugin_pluginrouting_5539c18e' // Source: .\\nuxt-i18n\\plugin.routing.js (mode: 'all')
import nuxt_plugin_pluginmain_0effbed6 from 'nuxt_plugin_pluginmain_0effbed6' // Source: .\\nuxt-i18n\\plugin.main.js (mode: 'all')
import nuxt_plugin_pluginclient_3e13eb93 from 'nuxt_plugin_pluginclient_3e13eb93' // Source: .\\content\\plugin.client.js (mode: 'client')
import nuxt_plugin_pluginserver_b86545ca from 'nuxt_plugin_pluginserver_b86545ca' // Source: .\\content\\plugin.server.js (mode: 'server')
import nuxt_plugin_workbox_9728e3c8 from 'nuxt_plugin_workbox_9728e3c8' // Source: .\\workbox.js (mode: 'client')
import nuxt_plugin_metaplugin_5936b2c8 from 'nuxt_plugin_metaplugin_5936b2c8' // Source: .\\pwa\\meta.plugin.js (mode: 'all')
import nuxt_plugin_iconplugin_4fe767e0 from 'nuxt_plugin_iconplugin_4fe767e0' // Source: .\\pwa\\icon.plugin.js (mode: 'all')
import nuxt_plugin_axios_208d5900 from 'nuxt_plugin_axios_208d5900' // Source: .\\axios.js (mode: 'all')
...
import nuxt_plugin_auth_04c73030 from 'nuxt_plugin_auth_04c73030' // Source: .\\auth.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_5486fd46 === 'function') {
    await nuxt_plugin_plugin_5486fd46(app.context, inject)
  }

  if (typeof nuxt_plugin_plugin_69f8ffb7 === 'function') {
    await nuxt_plugin_plugin_69f8ffb7(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_toast_2684b4a2 === 'function') {
    await nuxt_plugin_toast_2684b4a2(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginutils_05cb9524 === 'function') {
    await nuxt_plugin_pluginutils_05cb9524(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginrouting_5539c18e === 'function') {
    await nuxt_plugin_pluginrouting_5539c18e(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginmain_0effbed6 === 'function') {
    await nuxt_plugin_pluginmain_0effbed6(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_3e13eb93 === 'function') {
    await nuxt_plugin_pluginclient_3e13eb93(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_b86545ca === 'function') {
    await nuxt_plugin_pluginserver_b86545ca(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_workbox_9728e3c8 === 'function') {
    await nuxt_plugin_workbox_9728e3c8(app.context, inject)
  }

  if (typeof nuxt_plugin_metaplugin_5936b2c8 === 'function') {
    await nuxt_plugin_metaplugin_5936b2c8(app.context, inject)
  }

  if (typeof nuxt_plugin_iconplugin_4fe767e0 === 'function') {
    await nuxt_plugin_iconplugin_4fe767e0(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_208d5900 === 'function') {
    await nuxt_plugin_axios_208d5900(app.context, inject)
  }
  ...
  if (typeof nuxt_plugin_auth_04c73030 === 'function') {
    await nuxt_plugin_auth_04c73030(app.context, inject)
  }
