      ...
      <v-card-actions>
        <v-row>
          <v-col cols="12" sm="6" xs="12">
            <span class="text-h5">{{ $t("show beneficiaries") }}</span>
          </v-col>
...
<script>
import InputField from "~/transfers/components/InputField.vue";
export default {
  data() {
    return {
      sortBy: "fat",
